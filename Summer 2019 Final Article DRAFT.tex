...
\section{Method and Technical Approach}
	...
	\end{enumerate}
	where $\sigma_{a,~cell}$ is the absorption opacity of the cell the particle is in. The response value for each cell is then calculated by the following equation:
	\begin{equation}
